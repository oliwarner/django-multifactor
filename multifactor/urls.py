...
from . import views
from .factors import fido2, u2f, totp, fallback, singlefactor_fido2 as singlefactor
...
urlpatterns = [
    ...
    path('login/', singlefactor.auth, name="singlefactor_login"),
    path('login/begin-auth/', singlefactor.authenticate_begin, name="singlefactor_begin_auth"),
    path('login/complete-auth/', singlefactor.authenticate_complete, name="singlefactor_complete_auth"),

    path('fido2/new/', fido2.start, name="fido2_start"),
    path('fido2/verify/', fido2.auth, name="fido2_auth"),
    ...
    path('u2f/verify/', u2f.Auth.as_view(), name="u2f_auth"),

    path('totp/new/', totp.Create.as_view(), name="totp_start"),
    path('totp/verify/', totp.Auth.as_view(), name="totp_auth"),

    path('fallback/verify/', fallback.Auth.as_view(), name="fallback_auth"),
]
